...
const int rule_right_children_num_arr[] = {
    1, 10, 2, 2, 2, 2, 1, 2, 2, 1, 5, 2, 1, 4, 3, 1, 2, 1, 1, 0, 2, 1, 1, 1,
};
const int rule_left_id_arr[] = {
    16, 17, 20, 18, 19, 21, 21, 25, 22, 22, 26, 23, 23, 28, 30, 30, 31, 31, 31, 31, 27, 27, 29, 24,
};
static bool yyshift(std::stack<int>& states, std::stack<YYSTYPE>& syms, std::stack<LexToken>& input, bool* acc);
static bool yyreduce(std::stack<int>& states, std::stack<YYSTYPE>& syms, int r_id);
