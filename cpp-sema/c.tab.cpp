...
const int rule_right_children_num_arr[] = { 1,11,2,2,2,2,1,2,5,2,1,5,2,1,4,3,1,2,1,1,0,2,1,1,1,2,0, };
const int rule_left_id_arr[] = { 17,18,21,19,20,22,22,27,27,23,23,28,24,24,30,32,32,33,33,33,33,29,29,31,26,25,25, };
