...
const int rule_right_children_num_arr[] = { 1,2,1,1,1,1,1,1,5,7,4,2,2,3,3,1,2,3,1,1,0,2,2,1,2,3,1, };
const int rule_left_id_arr[] = { 23,25,25,24,24,24,24,24,26,27,28,29,30,31,35,35,36,32,32,37,33,33,38,38,34,40,40, };
...
Parser::yyreduce(std::stack<int>& states, std::stack<YYSTYPE>& syms, int r_id) {
    ...
    int curStateId  = states.top();
    int nextStateId = goto_table[curStateId][rule_left_id - 23];
